    ...
    public List<ConsultingListResponse> getMyConsultings(Long customerId) {
        ...
        return customer.getConsultings()
                ...
                .map(consulting -> ConsultingListResponse.builder()
                        ...
                        .tone(consulting.getConsultantTestResult().getTone().getName())
                        .bestColorSet(consulting.getConsultantTestResult().getBestColorSet().getColorSet().getColorColorSets()
                                .stream()
                                .map(colorColorSet -> colorColorSet.getColor().getHex())
                                .collect(Collectors.toList()))
                        .worstColorSet(consulting.getConsultantTestResult().getWorstColorSet().getColorSet().getColorColorSets()
                                .stream()
                                .map(colorColorSet -> colorColorSet.getColor().getHex())
                                .collect(Collectors.toList()))
                        .resultImageUrl(consulting.getConsultantTestResult().getConsultingFile())
                        .comment(consulting.getConsultantTestResult().getConsultingComment())
