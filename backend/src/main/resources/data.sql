...
-- 컨설턴트 진단결과
insert into consulting_result(created_date, last_modified_date, consulting_comment, image_url, is_active, best_color_set_id, worst_color_set_id, tone_id) values ('2022-07-15 16:00:00', '2022-07-15 16:00:00', '가을 소프트 타입이어서 베이지나 아이보리색의 톤온톤 코디가 가장 잘 어울리실 거에요~', '', 1, 1, 1, 7);
insert into consulting_result(created_date, last_modified_date, consulting_comment, image_url, is_active, best_color_set_id, worst_color_set_id, tone_id) values ('2022-07-23 11:00:00', '2022-07-23 11:00:00', '고객님은 여름 소프트까지 소화가능한 가을 소프트 타입이세요! 고명도 + 저채도의 톤이 가장 잘 맞아요!', '', 1, 2, 2, 7);
insert into consulting_result(created_date, last_modified_date, consulting_comment, image_url, is_active, best_color_set_id, worst_color_set_id, tone_id) values ('2022-08-01 20:00:00', '2022-08-01 20:00:00', '고객님을 보면 봄날의 햇살이 생각나네요 봄 브라이트세요!', '', 1, 3, 3, 1);
insert into consulting_result(created_date, last_modified_date, consulting_comment, image_url, is_active, best_color_set_id, worst_color_set_id, tone_id) values ('2022-07-10 14:00:00', '2022-07-10 14:00:00', '봉쥬르 고객님! 여태까지 웜톤인줄 아셨다구요? 아니에요 아니에요~ 고객님은 채도가 높은 색이 잘 어울리시는 겨울 브라이트 톤이세요! 이젠 맥 칠리 대신 맥 루비우 바르기로 약속!', '', 1, 4, 4, 10);
insert into consulting_result(created_date, last_modified_date, consulting_comment, image_url, is_active, best_color_set_id, worst_color_set_id, tone_id) values ('2022-07-15 19:00:00', '2022-07-15 19:00:00', '봉쥬르님은 확실히 쿨톤이세요! 쨍한 색감이 잘 어울리시거든요! 제가 본 봉쥬르님의 톤은 겨울 트루이십니다! 봉쥬르님은 탁한 색감을 쓰시면 안돼요! 말린 장미 노노 MLBB 노노!', '', 1, 5, 5, 11);

insert into consulting_result(created_date, last_modified_date, consulting_comment, image_url, is_active, best_color_set_id, worst_color_set_id, tone_id) values ('2022-07-13 20:00:00', '2022-07-13 20:00:00', '금발은 절대 하시면 안돼요! 오히려 노안이 될 수 있어요! 본연의 머리색을 그대로 유지하시는 게 베스트입니다!', '', 1, 6, 6, 3);
insert into consulting_result(created_date, last_modified_date, consulting_comment, image_url, is_active, best_color_set_id, worst_color_set_id, tone_id) values ('2022-07-23 17:00:00', '2022-07-23 17:00:00', '그윽한 음영 메이크업보다는 핑크핑크한 메이크업이 잘 어울리세요! 치크는 크리니크의 멜론팝 추천드려요~!', '', 1, 7, 7, 3);
insert into consulting_result(created_date, last_modified_date, consulting_comment, image_url, is_active, best_color_set_id, worst_color_set_id, tone_id) values ('2022-07-23 11:00:00', '2022-07-23 11:00:00', '가을 소프트하면 이성경이죠! 화장 세게 하지 마시고 음영 위주로만 하세요!', '', 1, 1, 1, 7);
insert into consulting_result(created_date, last_modified_date, consulting_comment, image_url, is_active, best_color_set_id, worst_color_set_id, tone_id) values ('2022-07-23 11:00:00', '2022-07-23 11:00:00', '윤아나 아이유를 보면서 화장과 코디를 참고하시면 좋을 거에요!', '', 1, 3, 3, 1);
insert into consulting_result(created_date, last_modified_date, consulting_comment, image_url, is_active, best_color_set_id, worst_color_set_id, tone_id) values ('2022-07-23 11:00:00', '2022-07-23 11:00:00', '고객님은 겨울 쿨톤 노노! 쿨톤이긴 하지만 여름 트루톤에요! 빨간 립스틱은 다 넣어두시고 핑크 립스틱 사기로 약속~!', '', 1, 10, 10, 5);

insert into consulting_result(created_date, last_modified_date, consulting_comment, image_url, is_active, best_color_set_id, worst_color_set_id, tone_id) values ('2022-07-23 11:00:00', '2022-07-23 11:00:00', '고객님은 쨍한 색이 엄청 잘 어울려요!!', '', 1, 4, 4, 10);
