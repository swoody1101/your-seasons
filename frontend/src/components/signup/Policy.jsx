      ...
      <PolicyBox>
        ...
        <ul class="list_indent2 mgt10">
          ...
          <p class="ls2">회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지, 만14세 미만 아동의 개인정보 처리 시 법정대리인의 동의여부 확인,
            고충처리 목적으로 개인정보를 처리합니다.</p><br />
          <p class="ls2">2. 재화 또는 서비스 제공</p>
          <p class="ls2">서비스 제공, 콘텐츠 제공, 본인인증을 목적으로 개인정보를 처리합니다.</p><br />
        </ul ><br /><br />
        <p class='lh6 bs4'><strong>제2조(개인정보의 처리 및 보유 기간)</strong><br />
          <br />① <em class="emphasis">
            [ 치명적인 당신]
        ...
        <ul class="list_indent2 mgt10">
          <li class="tt">1. [퍼스널컬러 컨설턴트 서비스 제공자]
          </li>
        ...
        <p class='lh6 bs4'><strong>제6조(개인정보의 파기절차 및 파기방법)<em class="emphasis"></em></strong></p>
        <p class='ls2'><br />①[치명적인 당신 ] 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.< br /> <br />②
          ...
          파기절차 < br />
          [치명적인 당신 ] 은(는) 파기 사유가 발생한 개인정보를 선정하고, [치명적인 당신] 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.< br /></p >
        ...
        <p class="ls2"><br /><br />① 정보주체는 치명적인 당신에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.</p>
        <p class='sub_p'>② 제1항에 따른 권리 행사는치명적인 당신에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 치명적인
          당신은(는) 이에 대해 지체 없이 조치하겠습니다.</p>
        ...
        <p class='sub_p'>⑥ 치명적인 당신은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.</p>
        <br /><br />
        ...
        <p class='sub_p mgt10'>1. 정기적인 자체 감사 실시<br /> 개인정보 취급 관련 안정성 확보를 위해 정기적(분기 1회)으로 자체 감사를 실시하고 있습니다.< br /> <br /> 2. 내부관리계획의
        ...
        <p class="ls2"><br /><br />① 치명적인 당신 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.<br />② 쿠키는
          ...
          <p class='lh6 bs4'><strong>제11조(추가적인 이용·제공 판단기준)<em class="emphasis"></em></strong><br /><br />
          ...
          <p class='lh6 bs4'>제12조(가명정보를 처리하는 경우 가명정보 처리에 관한 사항)<br /><br />
            [ 치명적인 당신] 은(는) 다음과 같은 목적으로 가명정보를 처리하고 있습니다.</p>
          <p class='sub_p'></p>
          ...
          <p class='sub_p mgt10'> ① <span class='colorLightBlue'>치명적인 당신</span> 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한
          ...
          <p class='sub_p'>※ 개인정보 보호 담당부서로 연결됩니다.
            ...
            <p class='sub_p'>② 정보주체께서는 치명적인 당신 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
              문의하실 수 있습니다. 치명적인 당신 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.</p><br /><br />
            <p class='lh6 bs4'>제14조(국내대리인의 지정)<br /><br />정보주체는 ｢개인정보 보호법｣ 제39조의11에 따라 지정된 [ 치명적인 당신]의
              국내대리인에게 개인정보 관련 고충처리 등의 업무를 위하여 연락을 취할 수 있습니다. [ 치명적인 당신]은(는) 정보주체의 개인정보 관련 고충처리 등 개인정보 보호책임자의 업무 등을 신속하게 처리할
              수 있도록 노력하겠습니다. <br /><br />▶ [ 치명적인 당신] 은(는) ｢개인정보 보호법｣ 제39조의11에 따라 국내대리인을 지정하였습니다.</p>
            <p class='sub_p'></p>
            <p class='sub_p'></p>
            ...
            <p class='sub_p mgt30'><strong>제15조(개인정보의 열람청구를 접수·처리하는 부서)<br /> 정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수
              있습니다.<br />
            ...
            <p class='lh6 bs4'><strong>제16조(정보주체의 권익침해에 대한 구제방법)<em class="emphasis"></em></strong></p><br /><br />정보주체는 개인정보침해로
